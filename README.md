...
Each repository should take full advantage of Github wiki's and include the following pages linked to from the the repositories' _wiki home_  page:
...
- `Sprint {SPRINT_NUMBER} Tickets`
  ...
  This page is generated by Github
